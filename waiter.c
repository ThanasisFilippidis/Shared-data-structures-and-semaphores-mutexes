...
int main(int argc, char const *argv[])
{
	...
	if (sh == (void *)-1) perror("Waiter Attachment.");
	else printf("Waiter %d arrived in place, getting in position.\n", waiterPosition);
